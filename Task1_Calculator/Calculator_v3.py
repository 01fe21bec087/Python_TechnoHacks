...
btn_clear = tk.Button(root, text="C", bg='red', command=clear_field, width=5, font=("Arial",14))  #pass the function as an entity, not Call the function 
btn_clear.grid(row=5, column=3)
btn_plus = tk.Button(root, text="+", command=lambda: add_to_calculation("+"), width=5, height=3, font=("Arial",14))
...
btn_equal = tk.Button(root, text="=", bg='green', command=evaluate_calculation, width=5, font=("Arial",14))
